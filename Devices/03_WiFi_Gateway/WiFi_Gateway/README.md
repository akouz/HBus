...
Sensor supplied from +5V rail. Sensor PWM output routed to GPIO13. After power-up there is no measurements fo 1 min. Measure C)2 level (ppm) output to topic gw/CO2.
