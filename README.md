...
While debugging nodes, it is possible to transfer text messages diorng the pause from EOF to Prefix. In normal operation all debugging traffic shold be switched off.
